...
import { requireActiveContext, requireAuth, requirePermission } from "../../middleware/auth.js"; import { validateBody } from "../../middleware/validate.js";
...
export const governanceRouter=Router(); governanceRouter.use(requireAuth,requireActiveContext);
