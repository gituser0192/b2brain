...
import { forgotPassword, login, logout, me, refresh, register, registrationInvitation, resetPassword } from "./auth.controller.js";
...
authRouter.post("/forgot-password", limiter, validateBody(forgotPasswordSchema), forgotPassword);
authRouter.post("/reset-password", limiter, validateBody(resetPasswordSchema), resetPassword);
