...
export function WorkspaceAgentHeader({ section, onSection }: { section: AgentSection; onSection: (section: AgentSection) => void }) {
  return <><header><div><p>SATHOS Agent</p><h2>Ask SATHOS</h2><span>Your organization-scoped Business Operating Agent.</span></div><div className="agent-trust"><span>✓ Permission aware</span><span>✓ Organization isolated</span><span>✓ Real business data</span></div></header>
    <nav className="workspace-agent-sections" aria-label="Ask SATHOS sections">
