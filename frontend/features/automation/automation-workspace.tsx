...
const foundations = [
  {
    ...
    title: "Notifications",
    description:
      "A central place for due follow-ups, agent escalations, failures, and approval requests.",
    capabilities: [
      "In-app inbox",
      "Due and overdue reminders",
      "Read and dismissed states",
    ],
  },
  {
    code: "agents",
    ...
    title: "AI agents",
    description:
      "Organization-owned agents with an approved purpose, permissions, instructions, and human oversight.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Automations",
    description:
      "Event-based workflows that connect business records to reminders, agents, and approved actions.",
    capabilities: [
      "Trigger and action rules",
      "Schedules and limits",
      "Pause and failure controls",
    ],
  },
  {
    code: "integrations",
    ...
    title: "Integrations",
    description:
      "Secure provider connections for calling, email, WhatsApp, calendars, transcription, and AI models.",
    capabilities: [
    ...
    <section className="automation-workspace">
      <header className="automation-header">
        <div>
          ...
          <span>
            The structure is ready for future providers. No agent can contact a
            customer yet.
          </span>
        </div>
      ...
      <div className="automation-empty-state">
        ...
        <section>
          ...
          <span>
            These records will only appear after an authorized administrator
            creates them. Nothing is seeded or simulated.
          </span>
        </section>
      </div>
    </section>
